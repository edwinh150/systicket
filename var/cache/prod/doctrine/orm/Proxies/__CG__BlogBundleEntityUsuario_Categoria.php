 ...
 */
class Usuario_Categoria extends \BlogBundle\Entity\Usuario_Categoria implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BlogBundle\\Entity\\Usuario_Categoria' . "\0" . 'id', '' . "\0" . 'BlogBundle\\Entity\\Usuario_Categoria' . "\0" . 'usuarioId', '' . "\0" . 'BlogBundle\\Entity\\Usuario_Categoria' . "\0" . 'categoriaId'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Usuario_Categoria $proxy) {
