 ...
 */
class Historial_Ticket extends \BlogBundle\Entity\Historial_Ticket implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BlogBundle\\Entity\\Historial_Ticket' . "\0" . 'id', '' . "\0" . 'BlogBundle\\Entity\\Historial_Ticket' . "\0" . 'idRegistro', '' . "\0" . 'BlogBundle\\Entity\\Historial_Ticket' . "\0" . 'ticketId', '' . "\0" . 'BlogBundle\\Entity\\Historial_Ticket' . "\0" . 'usuarioId', '' . "\0" . 'BlogBundle\\Entity\\Historial_Ticket' . "\0" . 'fecha', '' . "\0" . 'BlogBundle\\Entity\\Historial_Ticket' . "\0" . 'estado'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Historial_Ticket $proxy) {
    ...
    public function setIdRegistro($idRegistro)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdRegistro', [$idRegistro]);
    ...
    public function getIdRegistro()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdRegistro', []);
