 ...
 */
class Categoria_Ticket extends \BlogBundle\Entity\Categoria_Ticket implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BlogBundle\\Entity\\Categoria_Ticket' . "\0" . 'id', '' . "\0" . 'BlogBundle\\Entity\\Categoria_Ticket' . "\0" . 'idCategoria', '' . "\0" . 'BlogBundle\\Entity\\Categoria_Ticket' . "\0" . 'nombreCategoria'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Categoria_Ticket $proxy) {
