 ...
 */
class Roles extends \BlogBundle\Entity\Roles implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BlogBundle\\Entity\\Roles' . "\0" . 'id', '' . "\0" . 'BlogBundle\\Entity\\Roles' . "\0" . 'idRol', '' . "\0" . 'BlogBundle\\Entity\\Roles' . "\0" . 'nombre', '' . "\0" . 'BlogBundle\\Entity\\Roles' . "\0" . 'departamentoProyecto', '' . "\0" . 'BlogBundle\\Entity\\Roles' . "\0" . 'descripcion'];
        }
